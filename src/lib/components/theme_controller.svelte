<script>
  ...
  // Create a dispatcher to communicate with the parent component (navigation.svelte)
  const dispatch = createEventDispatcher();

  // Toggle theme between "dracula" and "acid"
  const toggleTheme = () => {
    ...
    dispatch("overlayToggle", currentTheme === "acid");
  };
